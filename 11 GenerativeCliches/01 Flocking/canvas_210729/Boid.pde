...
/*
    ...
    */
      ...
      float colorMappedX = map(velocity.x, 0, 2, 100, 255);
      float colorMappedY = map(velocity.y, 0, 2, 100, 255);
      ...
      } else if (boidsSizeSlider != null) circle(0, 0, boidsSizeSlider.getValue()*10); 
